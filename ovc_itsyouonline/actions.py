...
class Actions(ActionsBase):
    ...
    def configure(self, serviceObj):
        ...
        accesstoken = requests.post(os.path.join(baseurl, 'v1', 'oauth', 'access_token'), params=accesstokenparams)
        ...
        for group in groups:
            scopes.append('user:memberof:{}.{}'.format(client_id, group))

        data = {'instance.oauth.client.id': client_id,
