...
class Actions(ActionsBase):
    ...
    def initMasterVM(self, spacesecret, masterPasswd, publicipStart, publicipEnd, dcpmUrl, ovsUrl, portalUrl, oauthUrl, defenseUrl, delete=False):
        """
        this methods need to be run from the ovc_git VM
